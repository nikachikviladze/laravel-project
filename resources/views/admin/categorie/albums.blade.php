    ...
    <div class="x_content">
     ...
     <table id="datatable" class="table table-striped table-bordered">
      ...
      <tbody>
         ...
         <div class="modal fade bs-example-modal-sm{{ $item->id }}" tabindex="-1" role="dialog" aria-hidden="true">
           <div class="modal-dialog modal-sm">
             <div class="modal-content">
               ...
               <form action="{{ route('Catupdate', $item->id) }}" method="post">
                  <div class="modal-body">
       ...
       <!-- /modals -->
       <form action="{{ route('Catdestroy', $item->id) }}" method="post" style="display: inline-flex;">
