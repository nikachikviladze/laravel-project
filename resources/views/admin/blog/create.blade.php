          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <div class="" role="tabpanel" data-example-id="togglable-tabs">
                ...
                {!! Form::open(['action'=>'Admin\BlogController@store', 'method'=>'post', 'class'=>'form-horizontal form-label-left', 'files'=>true])!!}
                 <br>
                 <div class="clearfix"></div>
                 ...
                 <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-md-11 col-sm-11 col-xs-12">
                      <textarea id="editor1" name="description" class="form-control" cols="20" rows="5"></textarea>
                    </div>
                  ...
                  <div class="item form-group">
                   ...
                   <div class="col-md-11 col-sm-11 col-xs-12">
                     <select name="blog_categorie_id" id="" class="form-control">
